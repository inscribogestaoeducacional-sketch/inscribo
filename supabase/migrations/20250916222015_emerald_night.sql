...
-- Enable RLS for marketing campaigns
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_class c
...
-- Create marketing campaigns policy
DO $$
BEGIN
  IF NOT EXISTS (
    SELECT 1 FROM pg_policies 
