...
import { ArrowLeft, Building2, Users, Plus, Edit, Save, X } from 'lucide-react'
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          ...
          {/* Usuários da Instituição Selecionada */}
          <div className="bg-white rounded-lg shadow">
            {selectedInstitution ? (
              <>
                <div className="p-6 border-b">
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-sm text-gray-600 mt-1">Usuários cadastrados</p>
                    </div>
                    <button
              ...
              <div className="p-12 text-center text-gray-500">
                ...
                <p>Selecione uma instituição para ver seus usuários</p>
              </div>
            )}
          </div>
        </div>
