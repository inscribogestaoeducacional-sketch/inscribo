...
function CTAFinal() {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      await supabase.from('demo_requests').insert({ name:form.nome, email:form.email, school_name:form.escola, city:form.cidade, whatsapp:form.whatsapp, type:'demo' })
      setSent(true)
      window.open(`https://wa.me/5583985556393?text=${encodeURIComponent(`Olá! Sou ${form.nome} da escola ${form.escola} (${form.cidade||'Brasil'}) e quero agendar uma demonstração da Áion Edu.`)}`, '_blank')
