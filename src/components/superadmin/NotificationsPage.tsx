// src/components/superadmin/NotificationsPage.tsx
  ...
  const handleSendNotification = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (newNotification.target === 'all') {
        notificationData.user_role = 'all'
      } else if (newNotification.target === 'super_admin') {
        notificationData.user_role = 'super_admin'
      } else if (newNotification.target === 'institution') {
        notificationData.user_role = 'institution'
